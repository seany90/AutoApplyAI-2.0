    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md bg-slate-950 border-slate-800 text-slate-50">
        ...
        <div className="flex flex-col gap-2">
          <Button variant="outline" onClick={handleGoogleLogin} className="w-full bg-slate-900 border-slate-700 text-slate-200 hover:bg-slate-800 hover:text-white transition-colors">
          ...
          <Button variant="outline" onClick={handleGithubLogin} className="w-full bg-slate-900 border-slate-700 text-slate-200 hover:bg-slate-800 hover:text-white transition-colors">
